...
class TransferOperator(bpy.types.Operator):
    ...
    bl_description = 'Transfer the animation'
...
class AddIKOperator(bpy.types.Operator):
    ...
    bl_label = 'Add'
    bl_description = 'Append a new correction'
...
class RemoveIKOperator(bpy.types.Operator):
    ...
    bl_label = 'Remove'
    bl_description = 'Remove the last correction'
...
class ApplyIKOperator(bpy.types.Operator):
    ...
    bl_label = 'Apply'
    bl_description = 'Apply the corrections'
