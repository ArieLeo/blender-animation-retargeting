...
class EditOperator(bpy.types.Operator):
    ...
    bl_label = 'Create'
    bl_description = 'Create a new bone mapping'
...
class ApplyOperator(bpy.types.Operator):
    ...
    bl_label = 'Apply'
    bl_description = 'Apply the current bone mapping'
...
class ListActionOperator(bpy.types.Operator):
    ...
    bl_description = 'List current actions'
...
class ClearOperator(bpy.types.Operator):
    ...
    bl_description = 'Reset the bone mappings'
